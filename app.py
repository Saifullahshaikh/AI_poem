...
def index():
    if request.method == "POST":
        ...
        return render_template("index.html", poem=poem, audio_file=audio_file, images=image_urls)

    return render_template("index.html", poem=None, audio_file=None, images=None)
